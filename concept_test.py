...
import regex
sequence="""
GGGTTTGGGTTTGGGTTTGGGTTTTTTTTTTTGGTGTTTGGGTTTGGGTTTGGGTTTTTTTTTTTTGGGTTTGGGTTTGGGTTTGGGTTTTTTTTTTGGTGTTTGGGTTTGGGTTTGGGTTTGGTG
"""
...
G3_PB_greedy_pattern=r"""  ( [G]{3,} | (?P<mis>[G]{2,}[ATC][G]{1,}|[G]{1,}[ATC][G]{2,})) (\w{1,7}  (?(mis)[G]{3,}| ([G]{3,}|(?P<mis>[G]{2,}[ATC][G]{1,}|[G]{1,}[ATC][G]{2,})) )){3,} """
